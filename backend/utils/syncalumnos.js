...
// Sincroniza los alumnos de todos los cursos del profesor
export async function syncAlumnos(userId) {
  try {
    ...
    // Obtener cursos del profesor desde la base de datos
    ...
    // Recorrer cursos y traer alumnos desde Google Classroom
